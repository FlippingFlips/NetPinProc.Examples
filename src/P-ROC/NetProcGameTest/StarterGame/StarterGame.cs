...
namespace PinprocTest.StarterGame
{
    public class StarterGame : BasicGame
    {
        ...
        public void setup()
        {
            ...
            ball_save.AllowMultipleSaves = false;
            trough.BallSaveCallback = new AnonDelayedHandler(ball_save.LaunchCallback);
            trough.NumBallsToSaveCallback = new GetNumBallsToSaveHandler(ball_save.GetNumBallsToSave);
            ball_save.TroughEnableBallSave = new BallSaveEnable(trough.EnableBallSave);
        ...
        {
            this.dmd.SetMessage(text, seconds);
        }
        ...
        /// DrainCallback can be installed by a gameplay _mode
        /// </summary>
